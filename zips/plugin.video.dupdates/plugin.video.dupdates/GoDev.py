...
import base64, time
AddonID = 'plugin.video.dupdates'
ADDON=xbmcaddon.Addon(id='plugin.video.dupdates')
...
ServerURL = "http://s1.iptv66.tv:80/get.php?username=%s&password=%s&type=m3u&output=hls"%(Username,Password)
try:
...
def correctPVR():
	...
	dailyupdates = xbmcaddon.Addon('plugin.video.dupdates')
	username_text = dailyupdates.getSetting(id='Username')
	password_text = dailyupdates.getSetting(id='Password')
	jsonSetPVR = '{"jsonrpc":"2.0", "method":"Settings.SetSettingValue", "params":{"setting":"pvrmanager.enabled", "value":true},"id":1}'
	IPTVon 	   = '{"jsonrpc":"2.0","method":"Addons.SetAddonEnabled","params":{"addonid":"pvr.iptvsimple","enabled":true},"id":1}'
	nulldemo   = '{"jsonrpc":"2.0","method":"Addons.SetAddonEnabled","params":{"addonid":"pvr.demo","enabled":false},"id":1}'
	loginurl   = "http://s1.iptv66.tv:80/get.php?username=" + username_text + "&password=" + password_text + "&type=m3u_plus&output=ts"
	EPGurl     = "http://s1.iptv66.tv:80/xmltv.php?username=" + username_text + "&password=" + password_text + "&type=m3u_plus&output=ts"
	...
	dialog.ok("[COLOR orange]Stalker Client Set-up![/COLOR]",'Your stalker Client is set-up.',' ','[COLOR white]Please click on restart PVR.[/COLOR]')
...
def correctduPVR():
	...
	IPTVon 	   = '{"jsonrpc":"2.0","method":"Addons.SetAddonEnabled","params":{"addonid":"pvr.iptvsimple","enabled":true},"id":1}'
	nulldemo   = '{"jsonrpc":"2.0","method":"Addons.SetAddonEnabled","params":{"addonid":"pvr.demo","enabled":false},"id":1}'
	loginurl   = "http://cms.duremote.support:8981/get.php?username=" + username_text + "&password=" + password_text + "&type=m3u_plus&output=ts"
	EPGurl     = "http://cms.duremote.support:8981/xmltv.php?username=" + username_text + "&password=" + password_text + "&type=m3u_plus&output=ts"
	...
	moist.setSetting(id='m3uCache', value="false")
	moist.setSetting(id='epgCache', value="false")
	dialog.ok("[COLOR orange]Daily Updates Set-up![/COLOR]",'Your Daily Updates is set-up.',' ','[COLOR white]Please click on restart PVR.[/COLOR]')
	xbmc.executebuiltin("Container.Refresh")
def LaunchPVR():
	xbmc.executebuiltin('ActivateWindow(TVGuide)')
def Wipe_pvr():
    print '############################################################       DELETING PVR Data             ###############################################################'
    pvr = xbmc.translatePath('special://home/userdata/addon_data/pvr.iptvsimple/')
    shutil.rmtree(pvr)
    dialog.ok("[COLOR red]PVR Reset![/COLOR]",'Your pvr has now been deleted.',' ')
    xbmc.executebuiltin("UpdateLocalAddons")
    xbmc.executebuiltin("Container.Refresh")
def pvrrestart():
	xbmc.executebuiltin("StartPVRManager")
def speed():
	xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.dupdates/speedtest.py")')
...
def ExtraMenu():
    link = OPEN_URL('http://cms.duremote.support:8981/Extras/ExtrasList.xml').replace('\n','').replace('\r','')  #Spaf
